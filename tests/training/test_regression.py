...
def test_lgbm_incremental_regression_learner():
    df_train = pd.DataFrame({
        'id': ["id1", "id2", "id3", "id4"],
        'x1': [10.0, 13.0, 10.0, 13.0],
        "x2": [0, 1, 1, 0],
    ...
    list_df_train = [df_train[i:i+4] for i in range(0,df_train.shape[0],4)]
    ...
    predict_fn, pred_train, log = learner(list_df_train)
